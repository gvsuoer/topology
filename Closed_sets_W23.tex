\achapter{10}{Closed Sets in Metric Spaces}\label{chap:closed_sets}
...
\csection{Introduction}\label{sec_closed_sets_intro}
...
\csection{Closed Sets in Metric Spaces}\label{sec_closed_sets_metric}
...
\csection{Continuity and Closed Sets} \label{sec_cont_closed_sets}
...
\csection{Limit Points, Boundary Points, Isolated Points, and Sequences}\label{sec_limit_bound_iso_seq}
...
\csection{Limit Points and Closed Sets}\label{sec_limit_closed}
...
\csection{The Closure of a Set}\label{sec_set_closure}
...
\csection{Closed Sets and Limits of Sequences}\label{sec_closed_limits_seq}
...
\csection{Summary}\label{sec_closed_set_summ}
...
\csection{Exercises} \label{sec_closed_set_exer}
