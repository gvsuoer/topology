\achapter{1}{Sets}\label{chap:sets}
...
\csection{Introduction} \label{sec_sets_intro}
...
\csection{The Basic Idea of Topology}\label{sec_basic_top}
...
\csection{Intervals}\label{sec_intervals}
...
\csection{Unions, Intersections, and Complements of Sets}\label{sec_union_int_comp}
...
\csection{Cartesian Products of Sets}\label{sec_cart_prod}
...
\csection{Summary}\label{sec_sets_summ}
...
\csection{Exercises}\label{sec_sets_exer}
