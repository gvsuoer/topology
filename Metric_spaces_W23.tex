\achapter{3}{Metric Spaces} \label{chap:metric_spaces}
...
\csection{Introduction}\label{sec_metric_space_intro}
...
\csection{Metric Spaces}\label{sec_metric_space}
...
\csection{The Euclidean Metric on $\R^n$}\label{sec_euclid_rn}
...
\csection{Summary}\label{sec_metric_space_summ}
...
\csection{Exercises}\label{sec_metric_space_exer}
