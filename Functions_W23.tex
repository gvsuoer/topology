\achapter{2}{Functions}\label{chap:functions}
...
\csection{Introduction}\label{sec_func_intro}
...
\csection{Composites of Functions}\label{sec_comp_func}
...
\csection{Inverse Functions} \label{sec_inv_func}
...
\csection{Functions and Sets}\label{sec_fun_set}
...
\csection{The Cardinality of a Set}\label{sec_card_set}
...
\csection{Summary}\label{sec_func_summ}
...
\csection{Exercises}\label{sec_func_exer}
\be
