\achapter{13}{Closed Sets in Topological Spaces}\label{chap:Closed_sets_topology}
...
\csection{Introduction} \label{sec_closed_sets_top_intro}
...
\csection{Unions and Intersections of Closed Sets}\label{sec_union_inter_closed}
...
\csection{Limit Points and Sequences in Topological Spaces}\label{sec_limit_points}
...
\csection{Closure in Topological Spaces}\label{sec_top_closure}
...
\csection{The Boundary of a Set}\label{sec_set_boundary}
...
\csection{Separation Axioms}\label{sec_separation_ax}
...
\csection{Summary}\label{sec_closed_sets_top_summ}
...
\csection{Exercises}\label{sec_closed_sets_top_exer}
